...
const raceD = new Promise((resolve) =>
    setTimeout(() => resolve("RaceD resolved"), 1000)
);
const raceE = new Promise((_, reject) =>
    setTimeout(() => reject("RaceE reject"), 500)
);
const raceF = new Promise((resolve) =>
    setTimeout(() => resolve("RaceF resolved"), 800)
);
