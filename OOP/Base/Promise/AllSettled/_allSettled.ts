...
const settledA = new Promise((resolve) =>
    setTimeout(() => resolve("SettledA resolved"), 1000)
);
const settledB = new Promise((resolve) =>
    setTimeout(() => resolve("SettledB resolved"), 500)
);
const settledC = new Promise((resolve) =>
    setTimeout(() => resolve("SettledC resolved"), 800)
);
