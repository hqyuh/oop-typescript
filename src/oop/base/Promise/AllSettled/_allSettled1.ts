...
const settledD = new Promise((resolve) => setTimeout(() => resolve("SettledD resolved"), 1000));
const settledE = new Promise((_, reject) => setTimeout(() => reject("SettledE resolved"), 500));
const settledF = new Promise((resolve) => setTimeout(() => resolve("SettledF resolved"), 800));
